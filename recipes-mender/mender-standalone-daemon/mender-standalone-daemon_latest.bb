...
do_install () {
    ...
    install    -m 755 ${S}/mender-standalone-daemon.sh     ${D}${sbindir}

    install -d                                             ${D}${systemd_unitdir}/system
    install -m 0644 ${S}/mender-standalone-daemon.path     ${D}${systemd_unitdir}/system
    install -m 0644 ${S}/mender-standalone-daemon.service  ${D}${systemd_unitdir}/system
}
